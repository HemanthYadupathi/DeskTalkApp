...
public class Student_Adapter extends RecyclerView.Adapter<Student_Adapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        public LinearLayout mLayoutHeading;
        ...
        public MyViewHolder(View v) {
            ...
            mLayoutHeading = (LinearLayout) v.findViewById(R.id.layout_textstudentheading);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.mLayoutHeading.setOnClickListener(new View.OnClickListener() {
            @Override
